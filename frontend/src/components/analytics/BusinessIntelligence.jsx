        ...
        <div className="summary-grid">
          ...
          <div className="summary-card revenue">
            ...
            <div className="card-content">
              <div className="card-value">
                {formatCurrency(biData.executiveSummary.revenue.current)}
              </div>
          ...
          <div className="summary-card profitability">
            <div className="card-header">
              ...
              <div className="card-metrics">
                <span>
                  Gross:{' '}
                  {formatPercentage(biData.executiveSummary.profitability.grossMargin, false)}
                </span>
                <span>
                  Net: {formatPercentage(biData.executiveSummary.profitability.netMargin, false)}
                </span>
              </div>
            </div>
            <div className="card-content">
              <div className="card-value">
                {formatPercentage(biData.executiveSummary.profitability.roi, false)}
              </div>
          ...
          <div className="summary-card operations">
            <div className="card-header">
              ...
              <div className="card-metrics">
                <span>
                  OTD: {formatPercentage(biData.executiveSummary.operations.onTimeDelivery, false)}
                </span>
                <span>
                  CSAT:{' '}
                  {formatPercentage(biData.executiveSummary.operations.customerSatisfaction, false)}
                </span>
              </div>
            </div>
            <div className="card-content">
              <div className="card-value">
                {formatPercentage(biData.executiveSummary.operations.efficiency, false)}
              </div>
          ...
          <div className="summary-card growth">
            <div className="card-header">
              ...
              <div className="card-metrics">
                <span>
                  Market: {formatPercentage(biData.executiveSummary.growth.marketShare, false)}
                </span>
            ...
            <div className="card-content">
              <div className="card-value">
                {formatPercentage(biData.executiveSummary.growth.revenueGrowth)}
              </div>
            ...
            <div className="position-content">
              ...
              <div className="position-details">
                <div className="detail-item">
                  ...
                  <span>
                    {formatPercentage(biData.strategicMetrics.marketPosition.marketShare, false)}
                  </span>
                </div>
                <div className="detail-item">
                  <span>Growth Rate:</span>
                  <span
                    className={getGrowthColor(biData.strategicMetrics.marketPosition.growthRate)}
                  >
                ...
                <div className="detail-item">
                  ...
                  <span
                    className={getGrowthColor(biData.strategicMetrics.marketPosition.competitorGap)}
                  >
          ...
          <div className="metric-card">
            ...
            <div className="customer-metrics">
              <div className="metric-row">
                <div className="metric-item">
                  <span className="metric-value">
                    {biData.strategicMetrics.customerMetrics.totalCustomers.toLocaleString()}
                  </span>
                  <span className="metric-label">Total Customers</span>
                </div>
                <div className="metric-item">
                  <span className="metric-value">
                    {biData.strategicMetrics.customerMetrics.newCustomers}
                  </span>
              ...
              <div className="metric-row">
                <div className="metric-item">
                  <span className="metric-value">
                    {formatCurrency(biData.strategicMetrics.customerMetrics.ltv)}
                  </span>
                  <span className="metric-label">Lifetime Value</span>
                </div>
                <div className="metric-item">
                  <span className="metric-value">
                    {formatPercentage(biData.strategicMetrics.customerMetrics.churnRate, false)}
                  </span>
            ...
            <div className="excellence-radar">
              {Object.entries(biData.strategicMetrics.operationalExcellence).map(([key, value]) => (
                <div key={key} className="excellence-item">
                  <span className="excellence-label">
                    {key.charAt(0).toUpperCase() + key.slice(1)}
                  </span>
                  <div className="excellence-bar">
                    <div className="excellence-fill" style={{ width: `${value}%` }}></div>
                  </div>
      ...
      <div className="risk-assessment">
        ...
        <div className="risk-overview">
          <div className="risk-summary">
            ...
            <div className="risk-score">Overall Score: {biData.riskAssessment.score}/100</div>
          </div>
          ...
          <div className="risk-factors">
            {biData.riskAssessment.factors.map((factor, index) => (
              <div key={index} className="risk-factor">
                ...
                <div className="factor-trend">Trend: {factor.trend}</div>
              </div>
            ))}
          </div>
        </div>
            ...
            <div key={index} className="opportunity-card">
              <div className="opportunity-header">
                ...
                <div className="opportunity-badges">
                  ...
                  <span className="probability-badge">{opportunity.probability}% Probability</span>
                </div>
              </div>
