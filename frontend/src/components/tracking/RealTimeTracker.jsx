...
function RealTimeTracker({ shipment, onLocationUpdate }) {
  ...
  const getInitialLocation = () => {
    const cityCoordinates = {
      // USA
      'New York, USA': { lat: 40.7128, lng: -74.006, name: 'New York Port' },
      ...
      'Mumbai, India': { lat: 19.076, lng: 72.8777, name: 'Mumbai Port' },
      ...
      'Hyderabad, India': { lat: 17.385, lng: 78.4867, name: 'Hyderabad Hub' },
      ...
      'Buenos Aires, Argentina': { lat: -34.6118, lng: -58.396, name: 'Buenos Aires Port' },
    ...
    <div className="real-time-tracker">
      ...
      <div className="current-location">
        <div className="location-header">
          ...
          <span className="last-update">Updated {formatTime(currentLocation.timestamp)}</span>
        </div>
      ...
      <div className="tracker-actions">
        <button className="btn btn-secondary" onClick={() => setIsTracking(!isTracking)}>
          <Navigation size={16} />
